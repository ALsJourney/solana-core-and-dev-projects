...
export class StudentIntro {
  ...
  borshInstructionScheme = borsh.struct([
    borsh.u8("variant"),
    borsh.str("name"),
    borsh.str("message"),
  ]);
  ...
  serialize(): Buffer {
    ...
    this.borshInstructionScheme.encode({ ...this, variant: 0 }, buffer);
    return buffer.slice(0, this.borshInstructionScheme.getSpan(buffer));
  }
